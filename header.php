...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'gardens-of-babylon' ); ?></a>
				...
				<div class="col-md-4">
					...
					<ul class="announcement-bar__list">
						<li>
							...
							<a href="tel: +1 400-666-8888" class="text-decoration-none">+1 400-666-8888</a>
						</li>

						<li>
							<i class="bi bi-envelope rounded-circle"></i>
							<a href="mailto:hello@garden.shop" class="text-decoration-none">hello@garden.shop</a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-12 d-flex justify-content-center">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
						...
						<?php esc_html_e( 'Primary Menu', 'gardens-of-babylon' ); ?>
					</button>
				</div>
